# WBNS-0045 — Audio interruption background resume and timer continuity
...
## Goal
Harden audio unlock, calls/interruptions, backgrounding, tab switches, sleep/wake, explicit resume, clock changes, and session timer continuity on mobile browsers.
