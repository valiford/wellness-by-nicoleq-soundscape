# WBNS-0028 — Keyboard screen-reader and value-feedback mixer polish
...
## Goal
Improve keyboard increments, focus order, accessible labels/value announcements, mute state, visible focus, and live value feedback without changing audio authority.
