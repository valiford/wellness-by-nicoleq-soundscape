# WBNS-0046 — Keyboard screen-reader focus and value-feedback accessibility
...
## Goal
Improve keyboard increments, focus order, labels/value announcements, mute state, touch targets, visible focus, and live value feedback across all mixer controls.
