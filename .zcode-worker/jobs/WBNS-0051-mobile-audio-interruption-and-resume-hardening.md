# WBNS-0051 — Mobile audio interruption and resume hardening
...
## Goal
Harden browser audio unlock, calls/interruptions, backgrounding, tab switching, sleep/wake, explicit resume, and session continuity across iPhone Safari and Android Chrome.
